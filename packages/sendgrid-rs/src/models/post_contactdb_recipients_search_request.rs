...
impl PostContactdbRecipientsSearchRequest {
    pub fn new(list_id: Option<serde_json::Value>, conditions: Option<serde_json::Value>) -> PostContactdbRecipientsSearchRequest {
