...
impl SendersIdRequestBody {
    pub fn new(nickname: Option<serde_json::Value>, from: crate::models::PostMarketingSendersRequestFrom, address: Option<serde_json::Value>, city: Option<serde_json::Value>, country: Option<serde_json::Value>) -> SendersIdRequestBody {
