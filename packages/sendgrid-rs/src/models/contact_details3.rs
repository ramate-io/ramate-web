...
pub struct ContactDetails3 {
    ...
    #[serde(rename = "segment_ids", deserialize_with = "Option::deserialize")]
    pub segment_ids: Option<serde_json::Value>,
...
impl ContactDetails3 {
    pub fn new(id: Option<serde_json::Value>, list_ids: Option<serde_json::Value>, segment_ids: Option<serde_json::Value>, created_at: Option<serde_json::Value>, updated_at: Option<serde_json::Value>) -> ContactDetails3 {
        ContactDetails3 {
            id,
            first_name: None,
            last_name: None,
